    ...
    ?>
       ...
       // die($sql);
        ...
        while($row = $result->fetch_assoc())
        {
            ...
            echo "<td width=25%><a href=productdetail.php?code=" . $row["productid"] . "><p><img height=110 src=products/" . $row["productid"] . ".jpg></a><br><b><a href= productdetail.php?code=" .  $row["productid"] . ">" .  $row["productname"] . "</a></b><br><b>Price</b>: Rs. " . $row["price"] . "<br><a href=add2cart.php?product=" . $row["productid"] . "&qty=" . $row["minqty"] . ">Add to Cart</a></td></p>";
