...
<body bgcolor= #eee>
    ...
    if($row = $result->fetch_assoc())
    {
        ...
        echo "<tr><td>Order Status</td><td><form action=orderupdate.php method=post><input type=text name=txtOrderStatus value='" . $row["orderstatus"]. "'><input type=hidden name=txtOrderNo value=" . $oId . "><input type=submit value='submit'></form></td></tr>";
        echo "</table>";
        echo "</td><td>";
